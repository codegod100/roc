...
test "ModuleEnv.Serialized roundtrip" {
    ...
    // Plus unqualified type names: Num, Frac, Int, U8, U16, U32, U64, U128, I8, I16, I32, I64, I128, F32, F64, Dec
    // Plus unqualified main! identifier
    ...
    // Should have same 82 identifiers as original (see count breakdown above)
